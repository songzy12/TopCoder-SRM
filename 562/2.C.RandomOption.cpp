...
{3}
Returns: 0.6
There are 5 keys and only one bad pair. The probability that these lanes are
assigned to adjacent keys is 4 / (5 choose 2) = 0.4, so the probability that we
have a good arrangement is 1 - 0.4 = 0.6. 1)
5
{0, 1, 2}
{1, 2, 0}
Returns: 0.1
In a good arrangement, no two of the lanes 0, 1, and 2 may be adjacent. Hence
they have to be assigned to keys 0, 2, and 4, in some order. The probability of
this event is (3! * 2!) / 5! = 0.1. 2)
5
{2, 2, 2, 2}
{0, 1, 3, 4}
Returns: 0.0
All the pairs of lane 2 and other lanes are bad, so it is impossible to obtain a
good arrangement. 3)
7
{0, 1, 2}
{6, 5, 4}
